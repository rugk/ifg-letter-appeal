...
\begin{document}
	...
	\mailrepeat{
		\begin{letter}{%
			...
			% § 3 IFG Allg.
			% Generell besteht ein Regel-Ausnahme-Verhältnis, \enquote{die Verweigerung des Zugangs die begründungspflichtige Ausnahme}\cite{djvIfgKommentierung} darstellt. Auch sind Ausnahmetatbestände der §§\,3 bis 6 \enquote{nach den üblichen Auslegungsregeln eng zu verstehen}\cite{djvIfgKommentierung}.
			Generell gilt, dass
			...
			Es ist erforderlich \enquote{dass die Möglichkeit, dass das jeweilige Schutzgut beeinträchtigt wird, besteht und von der ablehnenden Behörde auch dargelegt wird}\cite{djvIfgKommentierung}.
			...
			% Verschlusssache
			Sollten Teile der Informationen als Verschlusssache eingestuft sein, so kann sich eine \enquote{Ablehnung eines Informationsantrages, die auf §\,3 Nr.\,4 gestützt werden soll, \textelp{} nicht auf den formellen Hinweis, es liege beispielsweise eine Verschlusssache vor, beschränken.}\cite[84][65]{djvIfgKommentierung}
