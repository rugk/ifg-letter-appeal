...
\renewcommand*\pagemark{%
	\usekomafont{pagenumber}{-~\thepage~von~\letterlastpage~-}%
}
...
\begin{document}
	...
	\mailrepeat{
		\begin{letter}{%
			...
			% § 3 IFG Allg.
			%Generell besteht ein Regel-Ausnahme-Verhältnis, \enquote{die Verweigerung des Zugangs die begründungspflichtige Ausnahme} [Mecklenburg, W. \& Pöppelmann, B. (2007). Informationsfreiheitsgesetz. Bonn: DJV.] darstellt. Auch sind Ausnahmetatbestände der §§\,3 bis 6 \enquote{nach den üblichen Auslegungsregeln eng zu verstehen}.
			Generell gilt, dass
			\enquote{in der Begründung einer ablehnenden Entscheidung \textelp{} die nachteiligen Auswirkungen konkret zu benennen und \textendash darzulegen} [Mecklenburg, W. \& Pöppelmann, B. (2007). Informationsfreiheitsgesetz. Bonn: DJV.] ist,
			\enquote{warum die Möglichkeit besteht, dass solche \textins{nachteilige} Auswirkungen \textins{nach §\,3 IFG Nr.~1} eintreten}[ebd.].
			Es ist erforderlich \enquote{dass die Möglichkeit, dass das jeweilige Schutzgut beeinträchtigt wird, besteht und von der ablehnenden Behörde auch dargelegt wird}[ebd.]
			...
			% Verschlusssache
			Sollten Teile der Informationen als Verschlussache eingestuft sein, so kann sich eine \enquote{Ablehnung eines Informationsantrages, die auf §\,3 Nr.\,4 gestützt werden soll, \textelp{} nicht auf den formellen Hinweis, es liege beispielsweise eine Verschlusssache vor, beschränken.}[Mecklenburg, W. \& Pöppelmann, B. (2007). Informationsfreiheitsgesetz. Bonn: DJV., S.~65, Punkt~84]
